...
// Step 1 of docs/sync-points-design.md keeps the prologue's lookup here; with both page tables
// folded into the halves of one binding it has nothing of its own to define, and the prologue
// calls the lookup above with half 1.
