...
Since 2026-09-13 the working line is `des-on-599`, upstream draft PR 599 plus the fork's
workaround, diagnostics and tooling; see
[docs/investigations/tutorial-gpu-crash-2026-09-13.md](docs/investigations/tutorial-gpu-crash-2026-09-13.md).
