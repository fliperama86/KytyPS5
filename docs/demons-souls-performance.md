...
is cheap, tested and correct, not Reverted (commit 76e47fd, then its revert): 1,279 lines of page-watch machinery with real correctness surface for no frame-rate change. Kept here as the measurement. Raw
