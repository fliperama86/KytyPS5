...
// loop replaying the first `frames` recorded frames in order (0 means every frame the capture
// holds). Reports milliseconds per loop and per frame on stdout and in replay-report.json next to
